            ...
            <main>
                <div class="container-fluid px-4 py-4">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form action="index.php?action=produk&subaction=simpan" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="nama_mobil" name="nama_mobil" placeholder="Contoh: Avanza" required>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" id="tahun" name="tahun" placeholder="Contoh: 2020" min="1990" max="2030">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="plat_nomor" class="form-label">Plat Nomor</label>
                                            <input type="text" class="form-control" id="plat_nomor" name="plat_nomor" placeholder="Contoh: G 1234 AB" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" id="harga_sewa_per_hari" name="harga_sewa_per_hari" placeholder="Contoh: 300000" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
